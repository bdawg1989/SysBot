...
namespace SysBot.Pokemon.Discord
{
    public class VGCTeam : ModuleBase<SocketCommandContext>
    {
        ...
        private DiscordColor GetTypeColor()
        {
        ...
        private static IEnumerable<ShowdownSet> ParseShowdownSets(string pokePasteHtml)
        {
            throw new NotImplementedException();
        }
        ...
        private static DiscordColor GetTypeColor1() => new DiscordColor(255, 165, 0); // Orange
        ...
        private static async Task<List<ShowdownSet>> GetShowdownSetsFromPokePasteUrl(string pokePasteUrl)
        {
            ...
            return (List<ShowdownSet>)showdownSets;
        }
    } }
